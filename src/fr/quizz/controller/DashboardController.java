...
import fr.quizz.view.item.ManageItem;
...
public class DashboardController extends Controller {
	...
	public JPanel showManagerItemPanel() throws DatabaseConnexionException{
		ItemModel pI = new ItemModel();
		ManageItem panelManageItem = new ManageItem(pI.getAllItem());
		return panelManageItem;
	}
